...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="alert alert-success" role="alert">共为您检索出{$blogs->num}篇博客</div>
            ...
            <ul class="pagination  pull-right">
                <li>
                    ...
                    {else}
                        <a href="http://localhost/projects/blog2.0/controller/search.php?nowpage={$lastpage}" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    {/if}
                ...
                *}
                ...
                {if $divide_blogs->total_page!=0}
                    <li><a href = "http://localhost/projects/blog2.0/controller/search.php?nowpage=1">{if $lastpage+1 ==1}<font color = "red">1</font>{else}1{/if}</a></li></li>
                {/if}
                {if $lastpage>3}
                    <li>..</li>
                    {for $page = $lastpage-1 to $lastpage}
                        <li><a href = "http://localhost/projects/blog2.0/controller/search.php?nowpage={$page}">{$page}</a></li>
                    {/for}
                {else}
                ...
                {if $lastpage+1 != 1}
                    <li><a href = "http://localhost/projects/blog2.0/controller/search.php?nowpage={$lastpage+1}"><font color = "red">{$lastpage+1}</font></a></li>
                {/if}
                ...
                {else}
                    <li>
                        <a href="http://localhost/projects/blog2.0/controller/search.php?nowpage={$nextpage}" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                {/if}

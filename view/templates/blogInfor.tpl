                    ...
                    <form action = "write.php" method="post" >
                        <div class="form-group">
                            <blockquote>
                                ...
                                <footer>create time：<cite title="Source Title">{$result[0]['add_time']}</cite></footer>
                                <footer>last modified time：<cite title="Source Title">{$result[0]['update_time']}</cite></footer>
                            </blockquote>

                            <div class="row">
                                <div class="col-md-12">

                                    <p class="lead">{$result[0]['content']}</p>
